import { RTL2832U_Provider } from "/node_modules/@jtarrio/webrtlsdr/dist/rtlsdr.js";
...
async function main() {
    preparePage();
    elements.startButton.addEventListener("click", loop);
    ...
    elements.stopButton.addEventListener("click", function () { clearInterval(interval) })
}
async function loop() {
